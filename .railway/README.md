...
and short-lived CRM and billing reconciliation cron workers. Product-event
delivery remains an application job but is not a persistent Railway service
until an analytics sink is selected.
