...
export function toWhatsappSession(
  ...
  return {
    ...
    humanAttendanceChangedAt: row.humanAttendanceChangedAt,
    humanAttendanceState: row.humanAttendanceState,
    humanAttendanceStateVersion: row.humanAttendanceStateVersion,
    humanHandlingStartedAt: row.humanHandlingStartedAt,
