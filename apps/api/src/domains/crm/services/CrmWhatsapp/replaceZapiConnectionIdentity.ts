...
export async function updateVerifiedZapiConnectionIdentity(
  ...
  logWhatsappServiceEvent(
    context,
    "crm.whatsapp.connection.zapi.identity_update.started",
    {
  ...
  const updated = await updateWhatsappConnection(
    context,
    {
      connectionId: input.connectionId,
  ...
  await auditWhatsappServiceEvent(context, {
    action: "crm.whatsapp.connection.zapi.credentials_rotated",
...
async function replaceZapiConnectionIdentity(
  ...
  return recordWhatsappServiceMutation(
    context,
    {
      action: "crm.whatsapp.connection.zapi.identity_replace",
      category: "data_change",
...
async function createReplacement(
  ...
  return runCrmTransaction(ports, async (transactionPorts) => {
    ...
    if (!archived) throw new WhatsappConnectionNotFoundError(current.id);
