...
export function Header() {
  ...
  return (
    ...
    >
      <nav
        className={cn(
          "flex h-16 w-full items-center justify-between pl-6 pr-0 md:h-14 md:transition-all md:ease-out",
          {
            "md:pl-5": scrolled,
          },
        )}
        ...
        <div className="hidden items-center gap-2 md:flex">
          ...
          <Link
            ...
            className={cn(
              ...
              "bg-brand text-white hover:bg-brand-dark rounded-full px-5 h-10",
            )}
          >
            Começar Agora
          </Link>
          ...
          <div className="flex flex-col gap-3 pb-8">
            ...
            <Link
              ...
              className={cn(
                buttonVariants({
                  className:
                    "w-full h-12 text-base rounded-xl bg-brand text-white",
                }),
              )}
            >
              Criar conta grátis
