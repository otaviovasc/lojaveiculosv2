...
export function ConnectionSectionCard({
  ...
  return (
    <section className={`crm-connection-card ${className}`.trim()}>
      <header>
...
export function ConnectionStatusCard({
  ...
  return (
    <section className="crm-connection-status-card" data-status={statusTone}>
      <span className="crm-connection-status-icon">
      ...
      <div>
        <span>{readCrmProviderLabel(connection.provider)}</span>
        <strong>{readProviderStatus(connection)}</strong>
        <small>{readConnectionStatusDetail(connection)}</small>
      </div>
      <span className="crm-connection-status-badge">
...
export function readProviderStatus(connection: CrmProviderConnection) {
  const provider = readCrmProviderLabel(connection.provider);
...
function readProviderStatusBadge(connection: CrmProviderConnection) {
...
function readProviderStatusTone(connection: CrmProviderConnection) {
...
function readConnectionStatusDetail(connection: CrmProviderConnection) {
