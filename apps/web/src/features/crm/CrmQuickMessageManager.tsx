...
import {
  ...
  QuickMediaField,
  QuickTemplateList,
} from "./CrmQuickMessageManagerParts";

export function CrmQuickMessageManager({
  disabled,
  messages,
  onClose,
  onCreate,
  ...
  onClose: () => void;
  onCreate: (input: CrmCreateQuickMessageInput) => Promise<boolean>;
  ...
  const [editing, setEditing] = useState<CrmQuickMessage | null>(null);
  const [file, setFile] = useState<File | null>(null);
  const [kind, setKind] = useState<CrmQuickMessageKind>("TEXT");
  ...
  const editMessage = (message: CrmQuickMessage) => {
  ...
  return (
    <CrmActionDialogShell
      onClose={onClose}
      panelClassName="crm-quick-manager"
    ...
    >
      ...
      <div className="crm-action-fields">
        <div className="crm-template-kind">
          <KindButton
            icon={<Type />}
            kind="TEXT"
            selected={kind}
