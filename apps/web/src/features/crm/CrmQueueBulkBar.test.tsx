...
function renderBulkBar(
  overrides: Partial<Parameters<typeof CrmQueueBulkBar>[0]> = {},
) {
  return render(
    <CrmQueueBulkBar
...
function createAssignableMember(id: number, name: string): CrmAssignableMember {
  return {
