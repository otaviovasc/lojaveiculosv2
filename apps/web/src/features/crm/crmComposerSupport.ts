...
import { isPreviewableMedia } from "./crmMediaFiles";
import type { CrmMessage, CrmQuickMessage } from "./crmConversationTypes";
...
export function formatReplyDraft(message: CrmMessage) {
