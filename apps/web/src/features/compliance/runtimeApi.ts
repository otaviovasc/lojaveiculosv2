import type { CreateComplianceApiOptions } from "./apiClient";
import type { ComplianceAuth } from "./types";

export async function createComplianceApiOptions(): Promise<CreateComplianceApiOptions> {
...
function readBaseUrl(): Pick<CreateComplianceApiOptions, "baseUrl"> {
