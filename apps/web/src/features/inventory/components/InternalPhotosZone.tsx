    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      {internalPhotos.length > 0 ? (
        ...
        <div className="col-span-full py-10 text-center flex flex-col items-center justify-center bg-panel/30 border border-line border-dashed rounded-xl">
          ...
          <label className="mt-3 inline-flex min-h-9 items-center justify-center gap-1.5 rounded-lg bg-blue-soft px-4 text-xs font-black text-blue-start hover:opacity-80 cursor-pointer border border-blue-soft/30">
