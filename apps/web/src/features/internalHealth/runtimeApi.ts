import type { CreateInternalHealthApiOptions } from "./apiClient";
import type { InternalHealthAuth } from "./types";

export async function createInternalHealthApiOptions(): Promise<CreateInternalHealthApiOptions> {
...
function createAuthFromEnv(accessToken?: string | null): InternalHealthAuth {
...
function readBaseUrl(): Pick<CreateInternalHealthApiOptions, "baseUrl"> {
