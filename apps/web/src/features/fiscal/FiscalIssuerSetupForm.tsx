...
export function FiscalIssuerSetupForm({
  ...
  return (
    <FeatureSection
      ...
      description="Dados oficiais da loja usados pelo provedor para criar a empresa emissora."
      icon={<Building2 aria-hidden="true" className="size-5" />}
      title="Empresa emissora"
    >
      <div className="mt-5 grid gap-5">
        <FeatureFormSection title="Identificação">
          <FeatureFieldGroup>
            ...
            <FeatureField error={errors.federalTaxNumber} label="CNPJ">
              <FeatureInput
                ...
                onChange={(event) =>
                  patch({
                    federalTaxNumber: formatBrazilianDocument(
                      event.target.value,
                    ),
                  })
                }
            ...
            >
              <FeatureInput
                ...
                disabled={busy}
                onChange={(event) =>
                  patch({ cityTaxNumber: event.target.value })
                }
        ...
        <FeatureFormSection title="Regime tributário (opcional)">
          <FeatureFieldGroup>
        ...
        <FeatureFormSection title="Endereço fiscal">
          <FeatureFieldGroup>
        ...
        <FeatureFormSection title="Atividades econômicas (opcional)">
          <FeatureFieldGroup>
            <FeatureField
              error={errors.mainActivityCode}
        ...
        {saved ? (
          <FeatureAlert tone="success">
            Dados da empresa enviados ao provedor. A conexão entrou em revisão
            até os padrões fiscais serem confirmados.
          </FeatureAlert>
        ) : null}
