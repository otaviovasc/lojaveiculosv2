...
| `CRM_ZAPI_CLIENT_TOKEN`                    | No                                                                    | staging, production        | Yes    | Server-owned ZAPI account Client-Token used authoritatively for every CRM ZAPI connection. Instance IDs and instance tokens remain connection-scoped.                                                                                                                                                                                                                                                                          |
| `ZAPI_CLIENT_TOKEN`                        | No                                                                    | staging, production        | Yes    | Legacy alias; it is not read by the CRM ZAPI runtime. Configure `CRM_ZAPI_CLIENT_TOKEN`.                                                                                                                                                                                                                                                                                                                                       |
