...
| Stock control          | lojaveiculos                                        | api/web           | Listing/unit split, hybrid 0km stock, expenses on unit/listing, sale flow, linked finance entries | Need V1 vehicle classification profile | Open   |
