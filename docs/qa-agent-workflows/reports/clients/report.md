...
- Latest worker commit: `a5ae89a`; merged to `agent/qa-integration` in `6a794a6`
...
- Focused tests:
  ...
  - Integration rerun: `pnpm --filter @lojaveiculosv2/web test -- crmPipelineModels` passed, 77 files / 236 tests.
