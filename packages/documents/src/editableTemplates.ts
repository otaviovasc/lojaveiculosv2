...
export const editableDocumentTemplates = [
  editable("sale_contract", "sale_contract", "Contrato de compra e venda", [
    fields("Dados do comprador", [{ label: "Comprador", token: "{{buyer.name}}" }, { label: "Documento", token: "{{buyer.document}}" }, { label: "Endereço", token: "{{buyer.address}}" }]),
  ...
  editable("sale_receipt", "sale_receipt", "Recibo de venda", [
    ...
    fields("Dados do veículo", vehicleFields),
    fields("Pagamento", [{ label: "Valor da venda", token: "{{finance.salePrice}}" }, { label: "Forma de pagamento", token: "{{finance.paymentMethod}}" }]),
  ...
  editable("delivery_term", "delivery_term", "Termo de entrega de veiculo", [
    fields("Veículo entregue", vehicleFields),
  ...
  editable("finance_entry_receipt", "finance_receipt", "Recibo de lancamento financeiro", [
    fields("Lançamento", [{ label: "Número", token: "{{document.number}}" }, { label: "Valor", token: "{{finance.salePrice}}" }, { label: "Forma de pagamento", token: "{{finance.paymentMethod}}" }]),
