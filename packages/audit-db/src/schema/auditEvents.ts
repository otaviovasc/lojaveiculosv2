...
export const auditEvents = pgTable(
  ...
  (table) => [
    ...
    index("audit_events_criticality_idx").on(table.criticality),
    index("audit_events_scope_occurred_at_idx").on(
      table.tenantId,
      table.storeId,
      table.occurredAt,
    ),
    ...
    index("audit_events_provider_idx").on(table.providerName),
